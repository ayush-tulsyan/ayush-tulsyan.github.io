...
\begin{tightitemize}
    ...
    \item Qualified for the \lgbf{Kishore Vaigyanik Protsahan Yojana} Fellowship under stream SX, 2014 with rank 226.
...
\begin{tightitemize}
        \small
        {
        \item Explored the possibility of \lgbf{SQL-on-Hadoop} replacing \lgbf{Sybase IQ}, the current data warehousing solution used by the enterprise.
        ...
        \item Evaluated the two using the guidelines provided by \lgbf{TPC-DS Benchmark}, on \lgbf{factors like query evaluation time, stability, scalability,} and \lgbf{cost}. Automated the complete process from data generation to recording statistics, while allowing users to configure conditions including \lgbf{the scale of data, number of concurrent users,} and \lgbf{resources available for computation}.
...
\begin{tightitemize}
        ...
        \item \lgbf{Designed a simpler and space efficient Dynamic DFS algorithm} superseding state-of-the-art by a logarithmic factor.
        }
\end{tightitemize}
...
\begin{tightitemize}
        ...
        \item {\textbf{Modern Cryptology}} Studied classical and modern cryptographic methods and their weaknesses. Designed Chosen plain text attacks for weaker models of DES, AES, and RSA and extracted the keys used to encrypt data. \hfill \href{https://github.com/arhamchopra/CS641-Assignments}{Github}
        \item \textbf{Video Broadcasting Service} A resource efficient python implementation of a concurrent video broadcasting server. \hfill \href{https://github.com/shivansh/CS425-Project}{Github}
...
\category{\normalsize{Programming Languages}} \hfill \bgemph{C, C++, Python, Oz, Bash, Javascript, PHP, SQL, HTML, CSS} \\
\category{\normalsize{Tools and Frameworks}} \hfill \bgemph{Git, \LaTeX\, GDB, Pytorch, Django, Wireshark, Octave, Matlab}
